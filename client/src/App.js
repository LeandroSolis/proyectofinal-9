      ...
      <div className="app">
        ...
        <div class="ListNotas">
          ...
          <div className="gh-bottom">
            <a href="https://github.com/LeandroSolis/proyectofinal-9" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 16" width="45" height="16">
